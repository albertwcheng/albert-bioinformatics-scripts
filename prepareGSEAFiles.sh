...
if [ $# -lt 7 ]; then
	...
	echo "make outprefix.exp.txt and outprefix.cls and outprefix.mwtcls outprefix.mwtg1 outprefix.mwtg2"
	exit
fi
...
echo $class1label > $outprefix.mwtg1
echo $class2label > $outprefix.mwtg2
